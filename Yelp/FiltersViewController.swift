...
//  Yelp
//
//  Created by Lam Hieu on 3/19/16.
...
@objc protocol FiltersViewControllerDelegate {
    optional func filterViewController(filtersViewController: FiltersViewController, didUpdateFilters filters: [String:AnyObject], selectedStates: [Int:Bool])
}
...
extension FiltersViewController: UITableViewDataSource, UITableViewDelegate, SwitchCellDelegate, SegmentedCellDelegate {
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        case 0:
            ...
            cell.switchLabel.text = "Offering a Deals"
            cell.delegate = self
            
            cell.onSwitch.on = isDealOffered
            return cell
        case 1:
